...
public class RSSAsync extends AsyncTask<Void, Integer, String>
{
	 String slider=": ";
	 int index=0;
	private XmlPullParserFactory xmlFactoryObject;
	   public volatile boolean parsingComplete = true;    
		...
		TextView upper;
		TextView upper_date;
    RSSAsync(ListView v,ArrayList<String> u,Context c_,ProgressBar s_,TextView t_,ImageView v_,TextView upper_,TextView date_,ArrayList<Boolean> ch)
    {
    	check_s=ch;
    	lv=v;
    	url_s=u;
